...
let created (value : string) = label "org.opencontainers.image.created" value
    
/// <summary>Contact details of the people or organization responsible for the 
/// image.</summary>
let authors  (value : string) = label "org.opencontainers.image.authors" value
    
/// <summary>URL to find more information on the image.</summary>
let url  (value : string) = label "org.opencontainers.image.url" value
    
/// <summary>URL to get documentation on the image.</summary>
let documentation  (value : string) = label "org.opencontainers.image.documentation" value
    
/// <summary>URL to get source code for building the image.</summary>
let source  (value : string) = label "org.opencontainers.image.source" value
...
let version  (value : string) = label "org.opencontainers.image.version" value
    
/// <summary>Source control revision identifier for the packaged software.</summary>
let revision  (value : string) = label "org.opencontainers.image.revision" value
    
/// <summary>Name of the distributing entity, organization or individual.</summary>
let vendor  (value : string) = label "org.opencontainers.image.vendor" value
    
/// <summary>License(s) under which contained software is distributed.</summary>
/// <param name="value">SPDX License Expression</param>
let licenses  (value : string) = label "org.opencontainers.image.licenses" value
...
/// </para>
/// </remarks>
let refName (value : string) = label "org.opencontainers.image.ref.name" value
    
/// <summary>Human-readable title of the image.</summary>
let title  (value : string) = label "org.opencontainers.image.title" value
    
/// <summary>Human-readable description of the software packaged in the image.</summary>
let description  (value : string) = label "rg.opencontainers.image.description" value
...
/// </remarks>
let baseDigest (value : string) = label "org.opencontainers.image.base.digest" value
...
/// </remarks>
let baseName (value : string) = label "org.opencontainers.image.base.name" value
