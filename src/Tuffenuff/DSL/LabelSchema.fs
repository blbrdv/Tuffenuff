...
[<Obsolete("Label Schema Convention is deprecated in favor of OCI IMAGE SPEC")>]
...
/// should have that version label. If Julia finds a version 0.7.1 in a repository she
